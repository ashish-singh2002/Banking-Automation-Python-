...
lbl_logo1=Label(win,image=imgtk)
lbl_logo1.place(x=0,y=0)
...
def login_screen():
    ...
    def login_db():
        ...
        if(acn=="" or pwd==""):
            ...
            if(tup==None):
                ...
                frm.destroy()
                welcome_screen()
    lbl_acn=Label(frm,text="Account No",bg='red',font=('Arial',20,'bold'))
    ...
    lbl_pass=Label(frm,text="Password",bg='red',font=('Arial',20,'bold'))
